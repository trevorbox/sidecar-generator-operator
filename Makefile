...
# example.com/sidecar-generator-operator-bundle:$VERSION and example.com/sidecar-generator-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= example.com/sidecar-generator-operator
...
KIND_CLUSTER ?= sidecar-generator-operator-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name sidecar-generator-operator-builder
	$(CONTAINER_TOOL) buildx use sidecar-generator-operator-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm sidecar-generator-operator-builder
	rm Dockerfile.cross
